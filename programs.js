...
const coachWorkouts = {
  week1: {
    title: "COACH SESSION A: 800m 10K Pace Repeats",
    buttonTitle: "COACH A",
    buttonSubtitle: "800m × 6",
    targetRpeMin: 6,
    targetRpeMax: 7,
    description: "코치용 800m 반복 훈련입니다. 세트 수를 6세트로 늘려 볼륨을 확보합니다.",
    steps: [
      {
        section: "BRIEFING",
        phase: "코치 훈련 안내",
        ...
        round: "800m × 6 Sets",
        message:
          "코치용 800m 반복 훈련입니다. 10km 페이스보다 조금 여유 있게 진행하며, 목표 RPE는 6-7입니다.",
      },
      {
        section: "WARM UP",
        phase: "Easy Jog",
      ...
      ]),
      {
        ...
        phase: "본훈련 안내",
        time: 60,
        target: "6 Sets For Time",
        paceOffset: 30,
        round: "800m + 90초 Easy Jog × 6 Sets",
        message:
          "이제 본세트입니다. 800m를 개인 기준 페이스보다 30초 느린 페이스로 6세트 진행합니다. 목표는 무리한 속도보다 안정적인 반복입니다.",
      },
      ...Array.from({ length: 6 }).flatMap((_, i) => [
        {
          ...
          round: `Set ${i + 1}/6`,
          message:
            "800m 구간입니다. 10km 페이스보다 살짝 여유 있게, RPE 6-7 정도로 안정적으로 유지하세요.",
        },
        {
          section: "MAIN SET",
  ...
  week2: {
    title: "COACH SESSION B: 8 Min 10K Pace Volume",
    buttonTitle: "COACH B",
    buttonSubtitle: "8 Min × 3",
    targetRpeMin: 7,
    targetRpeMax: 7,
    description: "코치용 8분 반복 훈련입니다. 10km 페이스보다 여유 있는 속도로 유산소 볼륨을 확보합니다.",
    steps: [
      {
        section: "BRIEFING",
        phase: "코치 훈련 안내",
        ...
        round: "8분 × 3 Sets",
        message:
          "코치용 8분 반복 훈련입니다. 10km 페이스보다 더 여유 있는 속도로 진행합니다. 목표 RPE는 7입니다.",
      },
      {
        section: "WARM UP",
        phase: "Easy Jog",
